...
As tabelas foram escolhidas de forma a manter a base de dados organizada, colocando ambos os doentes e os empregados numa tabela principal de pessoas e utilizando chaves estrangeiras para estabelecer a conexão entre essas duas tabelas e a tabela pessoas. 

As tabelas Médicos e Enfermeiros têm uma chave estrangeira - número de ordem - para realizar a conexão entre estas e a tabela empregados.
